...
<head>
    ...
    <title>System Settings - UniEvents Admin</title>
    ...
    <div class="flex h-screen w-full">
        <aside class="w-72 border-r border-slate-200 dark:border-slate-800 bg-surface-light dark:bg-surface-dark p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('user.admin_settings') }}" class="block px-3 py-2.5 rounded-lg bg-primary/10 text-primary">Settings</a>
            </nav>
        ...
        <main class="flex-1 flex flex-col">
            <header class="border-b border-slate-200 dark:border-slate-800 bg-surface-light dark:bg-surface-dark px-8 py-4">
                <h2 class="text-slate-900 dark:text-white text-xl font-bold">System Settings</h2>
            </header>
            <div class="flex-1 overflow-y-auto p-8">
                <div class="max-w-7xl">
                    <div class="bg-surface-light dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-800 p-8">
                        <p class="text-slate-500 dark:text-slate-400">System settings page coming soon...</p>
                    </div>
                </div>
            </div>
        </main>
